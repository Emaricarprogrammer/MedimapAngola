...
-- CreateTable
CREATE TABLE `_AquisicaoToAquisicao_medicamentos` (
    `A` VARCHAR(191) NOT NULL,
    `B` VARCHAR(191) NOT NULL,

    UNIQUE INDEX `_AquisicaoToAquisicao_medicamentos_AB_unique`(`A`, `B`),
    INDEX `_AquisicaoToAquisicao_medicamentos_B_index`(`B`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `tbl_aquisicao_medicamentos` ADD CONSTRAINT `tbl_aquisicao_medicamentos_id_medicamento_fkey` FOREIGN KEY (`id_medicamento`) REFERENCES `tbl_medicamentos`(`id_medicamento`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `tbl_recuperacao_senha` ADD CONSTRAINT `tbl_recuperacao_senha_id_conta_fk_fkey` FOREIGN KEY (`id_conta_fk`) REFERENCES `tbl_contas`(`id_conta`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `_AquisicaoToAquisicao_medicamentos` ADD CONSTRAINT `_AquisicaoToAquisicao_medicamentos_A_fkey` FOREIGN KEY (`A`) REFERENCES `tbl_aquisicao`(`id_aquisicao`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `_AquisicaoToAquisicao_medicamentos` ADD CONSTRAINT `_AquisicaoToAquisicao_medicamentos_B_fkey` FOREIGN KEY (`B`) REFERENCES `tbl_aquisicao_medicamentos`(`id_aquisicao_medicamento`) ON DELETE CASCADE ON UPDATE CASCADE;
