...
import { RequestsMedicineController } from "../../Controllers/PharmacyController/requests"
...
PharmacyRoute.route("/request/:id_farmacia").post(AuthenticationController.Authentication,AuthenticationController.PharmacyAuthentication,(req: Request, res: Response) =>{RequestsMedicineController.request(req, res)})
