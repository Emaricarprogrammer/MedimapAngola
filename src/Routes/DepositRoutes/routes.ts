...
DepositRouter.route("/medicamento/:nome_comercial").post(AuthenticationController.Authentication,(req:Request, res:Response) => {FindMedicineController.FindMedicine(req, res)})
DepositRouter.route("/medicamentos/:id_medicamento").patch(AuthenticationController.Authentication,(req:Request, res:Response) => {UpdateMedicineController.UpdateMedicine(req, res)})
DepositRouter.route("/medicamento/:id_medicamento").delete(AuthenticationController.Authentication,(req: Request, res: Response) => {DeleteMedicineController.DeleteMedicine(req, res)})
